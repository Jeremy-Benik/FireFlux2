...
#wind speed
ax[0, 0].plot(np.arange(240, 841), wsw, color = 'blue', label = 'West Tower') #plotting the wind speed from west tower
ax[0, 0].plot(np.arange(240, 841), wsw.rolling(window = n).mean(), color = 'black', linestyle = '--', label = '5s Rolling Average') #plotting the rolling average from the west tower wind speed
...
ax[0, 0].legend()
# w wind
ax[0, 1].plot(np.arange(240, 841), ww, color = 'blue', label = 'West Tower') #plotting the wind speed from west tower
ax[0, 1].plot(np.arange(240, 841), ww.rolling(window = n).mean(), color = 'black', linestyle = '--', label = '5s Rolling Average') #plotting the rolling average from the west tower wind speed
...
#wind speed
ax[1, 0].plot(np.arange(240, 841), wss, color = 'blue', label = 'South Tower') #plotting the wind speed from South tower
ax[1, 0].plot(np.arange(240, 841), wss.rolling(window = n).mean(), color = 'black', label = '5s Rolling Average') #plotting the rolling average from the South tower wind speed
...
# w wind
ax[1, 1].plot(np.arange(240, 841), ws, color = 'blue', label = 'South Tower') #plotting the wind speed from South tower
ax[1, 1].plot(np.arange(240, 841), ws.rolling(window = n).mean(), color = 'black', label = '5s Rolling Average') #plotting the rolling average from the South tower wind speed
...
#wind speed
ax[2, 0].plot(np.arange(240, 841), wse, color = 'blue', label = 'East Tower') #plotting the wind speed from South tower
ax[2, 0].plot(np.arange(240, 841), wse.rolling(window = n).mean(), color = 'black', label = '5s Rolling Average') #plotting the rolling average from the South tower wind speed
...
# w wind
ax[2, 1].plot(np.arange(240, 841), we, color = 'blue', label = 'East Tower') #plotting the wind speed from South tower
ax[2, 1].plot(np.arange(240, 841), we.rolling(window = n).mean(), color = 'black', label = '5s Rolling Average') #plotting the rolling average from the South tower wind speed
