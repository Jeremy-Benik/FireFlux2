...
path = r'/media/jeremy/Data/Fireflux2/Website_Docs/FF2Anemometers/' #setting the path to my files
...
for filename in filenames:
    ...
    ax[0].plot(date, speed, 'r', label='Wind Speed (m/s)')
    ...
    ax[1].plot(date, gust, 'b', label='Wind Gust (m/s)')
    ...
    ax[2].set_ylabel('U Wind (m/s)', fontsize=18, fontweight='bold')
    ...
    ax[3].set_ylabel('V Wind (m/s)', fontsize=18, fontweight='bold')
