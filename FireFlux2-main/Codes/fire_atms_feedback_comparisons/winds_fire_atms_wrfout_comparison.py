...
# Check the wind speeds since they look like they may be off. check the vertical velocities and the heat fluxes
# check the w on short towers, see if we have a higher heat flux there as that would lead to stronger fire induced winds
# Spend 5 minutes looking at the plot, ask does it make sense, make sure it's plotting the data I want it to 
...
# %% Just plotting the W Winds
# %% Plotting the W wind and the heat flux to see if they compare to the other winds
# Short Tower
fig, ax = plt.subplots(4, figsize = (15, 10))

# West Tower
ax1 = ax[0].twinx()
ax2 = ax[0].plot(time_fire * 60, abs(West_W_h_fire_533[0:774] - West_W_h_no_fire_533[0:774]), color = 'blue', label = 'West Tower W Wind')
ax[0].set_ylim(0, 6)
ax3 = ax1.plot(time_fire * 60, fghf_west[0:774], color = 'red', label = 'Ground Heat Flux')
ax1.set_ylim(0, 1000000)
ax1.set_ylabel('Ground Heat Flux (W/m^2)', fontsize = 10, fontweight = 'bold')
ax[0].set_title('West Tower W Fire Wind', fontsize = 18, fontweight = 'bold')
ax[0].set_xlabel('Time (Seconds)', fontsize = 12, fontweight = 'bold')
ax[0].set_ylabel('Wind Speed (m/s)', fontsize = 12, fontweight = 'bold')
ax[0].grid()
label = ax2 + ax3
...
# South Tower
ax1 = ax[1].twinx()
ax2 = ax[1].plot(time_fire * 60, abs(south_W_h_fire_533[0:774] - south_W_h_no_fire_533[0:774]), color = 'blue', label = 'South Tower W Wind')
ax[1].set_ylim(0, 6)
ax3 = ax1.plot(time_fire * 60, fghf_south[0:774], color = 'red', label = 'Ground Heat Flux')
ax1.set_ylim(0, 1000000)
ax1.set_ylabel('Ground Heat Flux (W/m^2)', fontsize = 10, fontweight = 'bold')
ax[1].set_title('South Tower W Fire Wind', fontsize = 18, fontweight = 'bold')
ax[1].set_xlabel('Time (Seconds)', fontsize = 12, fontweight = 'bold')
ax[1].set_ylabel('Wind Speed (m/s)', fontsize = 12, fontweight = 'bold')
ax[1].grid()
label = ax2 + ax3
labels = [i.get_label() for i in label]
leg = ax[1].legend(label, labels, prop={'size': 8}, loc = 3)

# East Tower
ax1 = ax[2].twinx()
ax2 = ax[2].plot(time_fire * 60, abs(east_W_h_fire_528[0:774] - east_W_h_no_fire_528[0:774]), color = 'blue', label = 'East Tower W Wind')
ax[2].set_ylim(0, 6)
ax3 = ax1.plot(time_fire * 60, fghf_east[0:774], color = 'red', label = 'Ground Heat Flux')
ax1.set_ylim(0, 1000000)
ax1.set_ylabel('Ground Heat Flux (W/m^2)', fontsize = 10, fontweight = 'bold')
ax[2].set_title('East Tower W Fire Wind', fontsize = 18, fontweight = 'bold')
ax[2].set_xlabel('Time (Seconds)', fontsize = 12, fontweight = 'bold')
ax[2].set_ylabel('Wind Speed (m/s)', fontsize = 12, fontweight = 'bold')
ax[2].grid()
label = ax2 + ax3
...
# Main tower
ax1 = ax[3].twinx()
ax2 = ax[3].plot(time_fire * 60, abs(W_h_fire_20[0:774] - W_h_no_fire_20[0:774]), color = 'purple', label = '20m W Wind')
ax3 = ax[3].plot(time_fire * 60, abs(W_h_fire_10[0:774] - W_h_no_fire_10[0:774]), color = 'blue', label = '10m W Wind')
ax4 = ax[3].plot(time_fire * 60, abs(W_h_fire_577[0:774] - W_h_no_fire_577[0:774]), color = 'green', label = '5.77m W Wind')
ax[3].set_ylim(0, 6)
ax5 = ax1.plot(time_fire * 60, fghf_main[0:774], color = 'red', label = 'Ground Heat Flux', linestyle = '--')
ax1.set_ylim(0, 1000000)
ax1.set_ylabel('Ground Heat Flux (W/m^2)', fontsize = 10, fontweight = 'bold')
ax[3].set_xlabel('Time (Seconds)', fontsize = 12, fontweight = 'bold')
ax[3].set_ylabel('Wind Speed (m/s)', fontsize = 12, fontweight = 'bold')
ax[3].set_title('Main Tower W Fire Winds', fontsize = 18, fontweight = 'bold')
ax[3].grid()
label = ax2 + ax3 + ax4 + ax5
labels = [i.get_label() for i in label]
leg = ax[3].legend(label, labels, prop={'size': 8}, loc = 3)


plt.tight_layout()
plt.show()

# %% Just plotting the w winds from the no fire to see how important no fire w wind is
...
# West Tower
ax1 = ax[0].twinx()
ax2 = ax[0].plot(time_fire[0:240] * 60, West_W_h_no_fire_533[0:240], color = 'blue', label = 'West Tower W Wind')
ax[0].set_ylim(0, 4)
ax3 = ax1.plot(time_fire[0:240] * 60, fghf_west[0:240], color = 'red', label = 'Ground Heat Flux')
ax1.set_ylim(0, 1000000)
ax1.set_ylabel('Ground Heat Flux (W/m^2)', fontsize = 10, fontweight = 'bold')
ax[0].set_title('West Tower W (fire_atms = 0)', fontsize = 18, fontweight = 'bold')
ax[0].set_xlabel('Time (Seconds)', fontsize = 12, fontweight = 'bold')
ax[0].set_ylabel('Wind Speed (m/s)', fontsize = 12, fontweight = 'bold')
ax[0].grid()
label = ax2 + ax3
...
# South Tower
ax1 = ax[1].twinx()
ax2 = ax[1].plot(time_fire[0:240] * 60, south_W_h_no_fire_533[0:240], color = 'blue', label = 'South Tower W Wind')
ax[1].set_ylim(0, 4)
ax3 = ax1.plot(time_fire[0:240] * 60, fghf_south[0:240], color = 'red', label = 'Ground Heat Flux')
ax1.set_ylim(0, 1000000)
ax1.set_ylabel('Ground Heat Flux (W/m^2)', fontsize = 10, fontweight = 'bold')
ax[1].set_title('South Tower W (fire_atms = 0)', fontsize = 18, fontweight = 'bold')
ax[1].set_xlabel('Time (Seconds)', fontsize = 12, fontweight = 'bold')
ax[1].set_ylabel('Wind Speed (m/s)', fontsize = 12, fontweight = 'bold')
ax[1].grid()
label = ax2 + ax3
...
# East Tower
ax1 = ax[2].twinx()
ax2 = ax[2].plot(time_fire[0:240] * 60, east_W_h_no_fire_528[0:240], color = 'blue', label = 'East Tower W Wind')
ax[2].set_ylim(0, 4)
ax3 = ax1.plot(time_fire[0:240] * 60, fghf_east[0:240], color = 'red', label = 'Ground Heat Flux')
ax1.set_ylim(0, 1000000)
ax1.set_ylabel('Ground Heat Flux (W/m^2)', fontsize = 10, fontweight = 'bold')
ax[2].set_title('East Tower W (fire_atms = 0)', fontsize = 18, fontweight = 'bold')
ax[2].set_xlabel('Time (Seconds)', fontsize = 12, fontweight = 'bold')
ax[2].set_ylabel('Wind Speed (m/s)', fontsize = 12, fontweight = 'bold')
ax[2].grid()
label = ax2 + ax3
...
# Main tower
ax1 = ax[3].twinx()
ax2 = ax[3].plot(time_fire[0:240] * 60, W_h_no_fire_20[0:240], color = 'purple', label = '20m W Wind')
ax3 = ax[3].plot(time_fire[0:240] * 60, W_h_no_fire_10[0:240], color = 'blue', label = '10m W Wind')
ax4 = ax[3].plot(time_fire[0:240] * 60, W_h_no_fire_577[0:240], color = 'green', label = '5.77m W Wind')
ax[3].set_ylim(0, 4)
ax5 = ax1.plot(time_fire[0:240] * 60, fghf_main[0:240], color = 'red', label = 'Ground Heat Flux', linestyle = '--')
ax1.set_ylim(0, 1000000)
ax1.set_ylabel('Ground Heat Flux (W/m^2)', fontsize = 10, fontweight = 'bold')
ax[3].set_xlabel('Time (Seconds)', fontsize = 12, fontweight = 'bold')
ax[3].set_ylabel('Wind Speed (m/s)', fontsize = 12, fontweight = 'bold')
ax[3].set_title('Main Tower W Winds (fire_atms = 0)', fontsize = 18, fontweight = 'bold')
ax[3].grid()
label = ax2 + ax3 + ax4 + ax5
labels = [i.get_label() for i in label]
leg = ax[3].legend(label, labels, prop={'size': 8}, loc = 3)
