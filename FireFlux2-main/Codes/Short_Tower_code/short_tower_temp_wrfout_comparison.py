...
#temperature
ax[0].plot(np.arange(240, 841), tw, color = 'blue', label = 'West Tower') #plotting the wind speed from west tower
ax[0].plot(np.arange(240, 841), tw.rolling(window = n).mean(), color = 'black', label = 'Rolling Average', linestyle = '--') #plotting the rolling average from the west tower wind speed
...
ax[0].set_ylabel('Temperature (\N{DEGREE SIGN}C)', fontsize = 12)
ax[0].set_title('West Tower Temperature (\N{DEGREE SIGN}C) vs. wrfout', fontsize = 13, fontweight = 'bold')
ax[0].legend()
# Plotting the South Tower
#temperature
ax[1].plot(np.arange(240, 841), ts, color = 'blue', label = 'South Tower') #plotting the wind speed from South tower
ax[1].plot(np.arange(240, 841), ts.rolling(window = n).mean(), color = 'black', label = 'Rolling Average', linestyle = '--') #plotting the rolling average from the South tower wind speed
...
ax[1].set_ylabel('Temperature (\N{DEGREE SIGN}C)', fontsize = 12)
ax[1].set_title('South Tower Temperature (\N{DEGREE SIGN}C) vs. wrfout', fontsize = 13, fontweight = 'bold')
ax[1].legend()
# Plotting the East Tower
#temperature
ax[2].plot(np.arange(240, 841), te, color = 'blue', label = 'East Tower') #plotting the wind speed from South tower
ax[2].plot(np.arange(240, 841), te.rolling(window = n).mean(), color = 'black', label = 'Rolling Average', linestyle = '--') #plotting the rolling average from the South tower wind speed
...
ax[2].set_ylabel('Temperature (\N{DEGREE SIGN}C)', fontsize = 12)
