...
T_h_20 = wrf.interplevel(T_wrfout, ht, 20)[240:841, south_north_wrfout, west_east_wrfout]
# 10 meters
print("Interpolating T at 10 meters")
T_h_10 = wrf.interplevel(T_wrfout, ht, 10)[240:841, south_north_wrfout, west_east_wrfout]
# 5.77 meters
print('Interpolating T at 5.77 meters')
T_h_577 = wrf.interplevel(T_wrfout, ht, 5.77)[240:841, south_north_wrfout, west_east_wrfout]
...
plt.tight_layout()
plt.savefig('/home/jbenik/FireFlux2/Codes_and_Data/Data/wrf_files/images/temperature_plot.png')
plt.show()