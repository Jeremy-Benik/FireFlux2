#/home/jbenik/FireFlux2/FireFlux2_modified_input_sounding
# %% Importing libraries
# %% Importing libraries
...
wrfout = nc.Dataset('/home/jbenik/FireFlux2/FireFlux2_modified_input_sounding/wrfinput_d01', 'r')
...
U_h_20 = wrf.interplevel(u_wrfout, ht, 20)[ y_main, x_main]
print("Interpolating V at 20 meters")
V_h_20 = wrf.interplevel(v_wrfout, ht, 20)[ y_main, x_main]
print("Calculating Wind Speed")
ws_h_20 = np.sqrt((U_h_20 ** 2) + (V_h_20 ** 2))
print("Interpolating W at 20 meters")
W_h_20 = wrf.interplevel(w_wrfout, ht, 20)[ y_main, x_main]

# 10 meters
print("Interpolating U at 10 meters")
U_h_10 = wrf.interplevel(u_wrfout, ht, 10)[ y_main, x_main]
print("Interpolating V at 10 meters")
V_h_10 = wrf.interplevel(v_wrfout, ht, 10)[ y_main, x_main]
ws_h_10 = np.sqrt((U_h_10 ** 2) + (V_h_10 ** 2))
print("Interpolating W at 10 meters")
W_h_10 = wrf.interplevel(w_wrfout, ht, 10)[ y_main, x_main]

# 5.77 meters
print('Interpolating U at 5.77 meters')
U_h_577 = wrf.interplevel(u_wrfout, ht, 5.77)[ y_main, x_main]
print("Interpolating V at 5.77 meters")
V_h_577 = wrf.interplevel(v_wrfout, ht, 5.77)[ y_main, x_main]
ws_h_577 = np.sqrt((U_h_577 ** 2) + (V_h_577 ** 2))
W_h_577 = wrf.interplevel(w_wrfout, ht, 5.77)[ y_main, x_main]
...
# 20 meters
ax[ 0].plot(np.array(wrfout.variables['XTIME'][0]) * 60, ws_h_20, label = 'wrfout file', color = 'red')
#ax[ 0].plot(np.array(wrfout.variables['XTIME'][:]), ws_h_20.rolling(window = n).mean(), label = 'Average Winds', color = 'black')
ax[ 0].set_xlabel('Time (seconds)', fontsize = 12)
ax[ 0].set_ylabel('Wind Speed (m/s)', fontsize = 12)
ax[ 0].set_xlim(230, 420)
ax[ 0].set_title("Wind Speed at 20 Meters", fontsize = 15, fontweight = 'bold')
ax[ 0].legend()

ax[ 1].plot(np.array(wrfout.variables['XTIME'][0]) * 60, ws_h_10, label = 'wrfout file', color = 'red')
#ax[ 1].plot(np.array(wrfout.variables['XTIME'][:]), ws_h_10.rolling(window = n).mean(), label = 'wrfout file', color = 'black')
ax[ 1].set_title("Wind Speed at 10 Meters", fontsize = 15, fontweight = 'bold')
ax[ 1].set_xlabel('Time (seconds)', fontsize = 12)
ax[ 1].set_ylabel('Wind Speed (m/s)', fontsize = 12)
ax[ 1].set_xlim(230, 420)
ax[ 1].legend()


ax[ 2].plot(np.array(wrfout.variables['XTIME'][0]) * 60, ws_h_577, label = 'wrfout file', color = 'red')
#ax[ 2].plot(np.array(wrfout.variables['XTIME'][:]), ws_h_577.rolling(window = n).mean(), label = 'wrfout file', color = 'black')
ax[ 2].set_xlabel('Time (seconds)', fontsize = 12)
ax[ 2].set_ylabel('Wind Speed (m/s)', fontsize = 12)
ax[ 2].set_xlim(230, 420)
ax[ 2].set_title("Wind Speed at 5.77 Meters", fontsize = 15, fontweight = 'bold')
ax[ 2].legend()


ax[1, 0].plot(np.array(wrfout.variables['XTIME'][0]) * 60, W_h_20, color = 'red', label = 'wrfout file')
...
ax[1, 1].plot(np.array(wrfout.variables['XTIME'][0]) * 60, W_h_10, color = 'red', label = 'wrfout file')
...
ax[1, 2].plot(np.array(wrfout.variables['XTIME'][0]) * 60, W_h_577, color = 'red', label = 'wrfout file')
...
ax[ 0].plot(np.array(wrfout.variables['XTIME'][0]) * 60, ws_h_20, label = 'wrfout file', color = 'red')
#ax[ 0].plot(np.array(wrfout.variables['XTIME'][:]), ws_h_20.rolling(window = n).mean(), label = 'Average Winds', color = 'black')
ax[ 0].plot(time2, ws_20, color = 'blue', label = 'Main Tower Data')
ax[ 0].plot(time2, ws_20.rolling(window = n).mean(), color = 'black', label = 'Rolling Average', linestyle = '--')
ax[ 0].set_xlabel('Time (seconds)', fontsize = 12)
ax[ 0].set_ylabel('Wind Speed (m/s)', fontsize = 12)
ax[ 0].set_xlim(230, 420)
ax[ 0].set_title("Wind Speed at 20 Meters", fontsize = 15, fontweight = 'bold')
...
ax[ 1].plot(np.array(wrfout.variables['XTIME'][0]) * 60, ws_h_10, label = 'wrfout file', color = 'red')
ax[ 1].plot(time2, ws_10, color = 'blue', label = 'Main Tower Data')
ax[ 1].plot(time2, ws_10.rolling(window = n).mean(), color = 'black', label = 'Rolling Average', linestyle = '--')
#ax[ 1].plot(np.array(wrfout.variables['XTIME'][:]), ws_h_10.rolling(window = n).mean(), label = 'wrfout file', color = 'black')
ax[ 1].set_title("Wind Speed at 10 Meters", fontsize = 15, fontweight = 'bold')
ax[ 1].set_xlabel('Time (seconds)', fontsize = 12)
ax[ 1].set_ylabel('Wind Speed (m/s)', fontsize = 12)
...
ax[ 2].plot(time2, ws_6, color = 'blue', label = 'Main Tower Data')
ax[ 2].plot(time2, ws_6.rolling(window = n).mean(), color = 'black', label = 'Rolling Average', linestyle = '--')
ax[ 2].plot(np.array(wrfout.variables['XTIME'][0]) * 60, ws_h_577, label = 'wrfout file', color = 'red')
#ax[ 2].plot(np.array(wrfout.variables['XTIME'][:]), ws_h_577.rolling(window = n).mean(), label = 'wrfout file', color = 'black')
ax[ 2].set_xlabel('Time (seconds)', fontsize = 12)
ax[ 2].set_ylabel('Wind Speed (m/s)', fontsize = 12)
