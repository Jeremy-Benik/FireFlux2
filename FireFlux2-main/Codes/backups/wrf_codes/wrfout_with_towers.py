...
print("wrfout file")
wrfout = nc.Dataset('/home/jbenik/FirefluxII/Codes_and_Data/Data/wrf_files/wrfout_d01_2013-01-30_15:00:00', 'r')
wrfout_xr = xr.open_dataset('/home/jbenik/FirefluxII/Codes_and_Data/Data/wrf_files/wrfout_d01_2013-01-30_15:00:00')
...
U_h_20 = interplevel(u_wrfout, ht, 20)[241:361, 190, 93]
print("Interpolating V at 20 meters")
V_h_20 = interplevel(v_wrfout, ht, 20)[241:361, 190, 93]
print("Calculating Wind Speed")
ws_h_20 = np.sqrt((U_h_20 ** 2) + (V_h_20 ** 2))
print("Interpolating W at 20 meters")
W_h_20 = interplevel(w_wrfout, ht, 20)[241:361, 190, 93]
print("Interpolating T at 20 meters")
T_h_20 = interplevel(T_wrfout, ht, 20)[241:361, 190, 93]
# 10 meters
print("Interpolating U at 10 meters")
U_h_10 = interplevel(u_wrfout, ht, 10)[241:361, 190, 93]
V_h_10 = interplevel(v_wrfout, ht, 10)[241:361, 190, 93]
ws_h_10 = np.sqrt((U_h_10 ** 2) + (V_h_10 ** 2))
W_h_10 = interplevel(w_wrfout, ht, 10)[241:361, 190, 93]
T_h_10 = interplevel(T_wrfout, ht, 10)[241:361, 190, 93]
# 5.77 meters
U_h_577 = interplevel(u_wrfout, ht, 5.77)[241:361, 190, 93]
V_h_577 = interplevel(v_wrfout, ht, 5.77)[241:361, 190, 93]
ws_h_577 = np.sqrt((U_h_577 ** 2) + (V_h_577 ** 2))
W_h_577 = interplevel(w_wrfout, ht, 5.77)[241:361, 190, 93]
T_h_577 = interplevel(T_wrfout, ht, 5.77)[241:361, 190, 93]
# %% Making the plots
...
ax[0, 0].plot(np.array(wrfout.variables['XTIME'][241:361]) * 60, ws_h_20, label = 'wrfout file', color = 'red')
...
ax[0, 1].plot(np.array(wrfout.variables['XTIME'][241:361]) * 60, ws_h_10, label = 'wrfout file', color = 'red')
...
ax[0, 2].plot(np.array(wrfout.variables['XTIME'][241:361]) * 60, ws_h_577, label = 'wrfout file', color = 'red')
...
ax[1, 0].plot(np.array(wrfout.variables['XTIME'][241:361]) * 60, T_h_20, color = 'red', label = 'wrfout file')
...
ax[1, 1].plot(np.array(wrfout.variables['XTIME'][241:361]) * 60, T_h_10, color = 'red', label = 'wrfout file')
...
ax[1, 2].plot(np.array(wrfout.variables['XTIME'][241:361]) * 60, T_h_577, color = 'red', label = 'wrfout file')
...
ax[2, 0].plot(np.array(wrfout.variables['XTIME'][241:361]) * 60, W_h_20, color = 'red', label = 'wrfout file')
...
ax[2, 1].plot(np.array(wrfout.variables['XTIME'][241:361]) * 60, W_h_10, color = 'red', label = 'wrfout file')
...
ax[2, 2].plot(np.array(wrfout.variables['XTIME'][241:361]) * 60, W_h_577, color = 'red', label = 'wrfout file')
...
plt.tight_layout()
plt.savefig('/home/jbenik/FirefluxII/Codes_and_Data/Data/wrf_files/images/wrfout_with_towers2.png')
plt.show()
# %% Short towers
n = 5 #this is a 5 second average of the data
df_w1 = pd.read_csv('/home/jbenik/FirefluxII/Codes_and_Data/Data/Short_Tower_Data/Proc_FF2_1HzSTWdespikedrotated.csv')
...
df_e1 = pd.read_csv('/home/jbenik/FirefluxII/Codes_and_Data/Data/Short_Tower_Data/Proc_FF2_1HzSTEdespikedrotated.csv')

df_e = df_e1.truncate(before= np.where(df_e1['TIMESTAMP'] == '1/30/2013 15:04')[0][0], 
                    after=np.where(df_e1['TIMESTAMP'] == '1/30/2013 15:06')[0][0])

df_s1 = pd.read_csv('/home/jbenik/FirefluxII/Codes_and_Data/Data/Short_Tower_Data/Proc_FF2_1HzSTSdespikedrotated.csv')

df_s = df_s1.truncate(before= np.where(df_s1['TIMESTAMP'] == '1/30/2013 15:04')[0][0], 
                    after=np.where(df_s1['TIMESTAMP'] == '1/30/2013 15:06')[0][0])
...
#west tower
Uw_h_533 = interplevel(u_wrfout, ht, 5.33)[241:361, 94, 151]
Vw_h_533 = interplevel(v_wrfout, ht, 5.33)[241:361, 94, 151]
wsw_h_33 = np.sqrt((Uw_h_533 ** 2) + (Vw_h_533 ** 2))
Ww_h_533 = interplevel(w_wrfout, ht, 5.33)[241:361, 94, 151]
Tw_h_533 = interplevel(T_wrfout, ht, 5.33)[241:361, 94, 151]

#east tower
Ue_h_528 = interplevel(u_wrfout, ht, 5.28)[241:361, 116, 158]
Ve_h_528 = interplevel(v_wrfout, ht, 5.28)[241:361, 116, 158]
wse_h_528 = np.sqrt((Ue_h_528 ** 2) + (Ve_h_528 ** 2))
We_h_528 = interplevel(w_wrfout, ht, 5.28)[241:361, 116, 158]
Te_h_528 = interplevel(T_wrfout, ht, 5.28)[241:361, 116, 158]


#south tower
Us_h_533 = interplevel(u_wrfout, ht, 5.33)[241:361, 115, 119]
Vs_h_533 = interplevel(v_wrfout, ht, 5.33)[241:361, 115, 119]
wss_h_533 = np.sqrt((Us_h_533 ** 2) + (Vs_h_533 ** 2))
Ws_h_533 = interplevel(w_wrfout, ht, 5.33)[241:361, 115, 119]
Ts_h_533 = interplevel(T_wrfout, ht, 5.33)[241:361, 115, 119]
...
#wind speed
ax[0, 0].plot(np.arange(240, 360), wsw, color = 'blue', label = 'West Tower Wind Speed (m/s)') #plotting the wind speed from west tower
ax[0, 0].plot(np.arange(240, 360), wsw.rolling(window = n).mean(), color = 'black', label = 'West Tower Rolling Average') #plotting the rolling average from the west tower wind speed
ax[0, 0].plot(np.array(wrfout.variables['XTIME'][241:361]) * 60, wsw_h_533, color = 'red', label = 'wrfout file') #plotting the wind speed from the wrfout file
...
# w wind
ax[0, 1].plot(np.arange(240, 360), ww, color = 'blue', label = 'West Tower W Wind Speed (m/s)') #plotting the wind speed from west tower
ax[0, 1].plot(np.arange(240, 360), ww.rolling(window = n).mean(), color = 'black', label = 'West Tower Rolling Average') #plotting the rolling average from the west tower wind speed
ax[0, 1].plot(np.array(wrfout.variables['XTIME'][241:361]) * 60, Ww_h_533, color = 'red', label = 'wrfout file') #plotting the wind speed from the wrfout file
...
#temperature
ax[0, 2].plot(np.arange(240, 360), tw, color = 'blue', label = 'West Tower Temp (C)') #plotting the wind speed from west tower
ax[0, 2].plot(np.arange(240, 360), tw.rolling(window = n).mean(), color = 'black', label = 'West Tower Rolling Average') #plotting the rolling average from the west tower wind speed
ax[0, 2].plot(np.array(wrfout.variables['XTIME'][241:361] * 60), Tw_h_533, color = 'red', label = 'wrfout file') #plotting the wind speed from the wrfout file
...
#wind speed
ax[1, 0].plot(np.arange(240, 360), wss, color = 'blue', label = 'South Tower Wind Speed (m/s)') #plotting the wind speed from South tower
ax[1, 0].plot(np.arange(240, 360), wss.rolling(window = n).mean(), color = 'black', label = 'South Tower Rolling Average') #plotting the rolling average from the South tower wind speed
ax[1, 0].plot(np.array(wrfout.variables['XTIME'][241:361]) * 60, wss_h_533, color = 'red', label = 'wrfout file') #plotting the wind speed from the wrfout file
...
# w wind
ax[1, 1].plot(np.arange(240, 360), ws, color = 'blue', label = 'South Tower W Wind Speed (m/s)') #plotting the wind speed from South tower
ax[1, 1].plot(np.arange(240, 360), ws.rolling(window = n).mean(), color = 'black', label = 'South Tower Rolling Average') #plotting the rolling average from the South tower wind speed
ax[1, 1].plot(np.array(wrfout.variables['XTIME'][241:361]) * 60, Ws_h_533, color = 'red', label = 'wrfout file') #plotting the wind speed from the wrfout file
...
#temperature
ax[1, 2].plot(np.arange(240, 360), ts, color = 'blue', label = 'South Tower Temp (C)') #plotting the wind speed from South tower
ax[1, 2].plot(np.arange(240, 360), ts.rolling(window = n).mean(), color = 'black', label = 'South Tower Rolling Average') #plotting the rolling average from the South tower wind speed
ax[1, 2].plot(np.array(wrfout.variables['XTIME'][241:361]) * 60, Ts_h_533, color = 'red', label = 'wrfout file') #plotting the wind speed from the wrfout file
...
#wind speed
ax[2, 0].plot(np.arange(240, 360), wse, color = 'blue', label = 'South Tower Wind Speed (m/s)') #plotting the wind speed from South tower
ax[2, 0].plot(np.arange(240, 360), wse.rolling(window = n).mean(), color = 'black', label = 'South Tower Rolling Average') #plotting the rolling average from the South tower wind speed
ax[2, 0].plot(np.array(wrfout.variables['XTIME'][241:361]) * 60, wse_h_528, color = 'red', label = 'wrfout file') #plotting the wind speed from the wrfout file
...
# w wind
ax[2, 1].plot(np.arange(240, 360), we, color = 'blue', label = 'South Tower W Wind Speed (m/s)') #plotting the wind speed from South tower
ax[2, 1].plot(np.arange(240, 360), we.rolling(window = n).mean(), color = 'black', label = 'South Tower Rolling Average') #plotting the rolling average from the South tower wind speed
ax[2, 1].plot(np.array(wrfout.variables['XTIME'][241:361]) * 60, We_h_528, color = 'red', label = 'wrfout file') #plotting the wind speed from the wrfout file
...
#temperature
ax[2, 2].plot(np.arange(240, 360), te, color = 'blue', label = 'South Tower Temp (C)') #plotting the wind speed from South tower
ax[2, 2].plot(np.arange(240, 360), te.rolling(window = n).mean(), color = 'black', label = 'South Tower Rolling Average') #plotting the rolling average from the South tower wind speed
ax[2, 2].plot(p.array(wrfout.variables['XTIME'][241:361]) * 60, Te_h_528, color = 'red', label = 'wrfout file') #plotting the wind speed from the wrfout file
...
plt.tight_layout()
plt.savefig('/home/jbenik/FirefluxII/Codes_and_Data/Data/wrf_files/images/wrfout_with_towers3.png')
