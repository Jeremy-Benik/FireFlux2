...
T_h_20 = wrf.interplevel(T_wrfout, ht, 20)[240:420, y_main, x_main]

# 10 meters
print("Interpolating U at 10 meters")
T_h_10 = wrf.interplevel(T_wrfout, ht, 10)[240:420, y_main, x_main]
# 5.77 meters
print('Interpolating T at 5.77 meters')
T_h_577 = wrf.interplevel(T_wrfout, ht, 5.77)[240:420, y_main, x_main]
# %% Making the plots
...
# 20 meters
ax[0].plot(time2, ts20, color = 'blue', label = 'Main tower Data')
...
ax[1].plot(time2, ts10, color = 'blue', label = 'Main tower Data')
...
ax[2].plot(time2, ts6, color = 'blue', label = 'Main tower Data')
